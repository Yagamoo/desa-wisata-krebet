...
@section('content')
                ...
                <div class="ibox-content">
                    <div class="row mb-3">
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <form method="GET" action="{{ route('admin.keuangan.pengeluaran') }}" class="mb-3">
                    ...
                    <div class="row g-3">
                        <div class="col-lg-12">
                            <div class="card bg-warning text-dark text-center p-4 shadow-sm"
                                ...
                                <p class="h5 mb-0">Rp. {{ number_format($pengeluaran, 0, ',', '.') }}
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-12">
            <div class="ibox">
                <div class="ibox-title d-flex justify-content-between align-items-center px-3 py-2 bg-primary">
                    ...
                    <div>
                        <a href="{{ route('admin.keuangan.pengeluaran.create') }}" class="btn btn-warning"><i
                                    ...
                                    <div>
                                        <div class="d-flex align-items-center justify-content-between mb-2">
                                            <h3 class="font-weight-bolder mb-0">
                                                {{ $items->booking->organisasi ?? 'Krebet' }}</h3>
                                            <span
    ...
    {{-- <div class="row justify-content-center mb-5 m-3 card p-3 px-1">
        <div class="card-title m-0 mb-2 px-4 p-1 d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('admin.keuangan.pengeluaran.create') }}" class="btn btn-outline-warning bg-warning-subtle"><i
                    class="fa-solid fa-plus"></i> Tambah
                Pengeluaran</a>
        </div>
