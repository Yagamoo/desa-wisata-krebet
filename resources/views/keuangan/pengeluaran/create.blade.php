    ...
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="{{ route('admin.keuangan.pengeluaran') }}">Pengeluaran</a>
            </li>
...
@section('content')
    {{-- <div class="card p-3 m-3 mt-5">
        <h5 class="m-0 fw-bold">Form Tambah Pengeluaran</h5>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb small m-0 mt-2">
                <li class="breadcrumb-item small"><a href="{{ route('admin.keuangan.pengeluaran') }}"
                        class="text-decoration-none">Pengeluaran</a></li>
                <li class="breadcrumb-item small active" aria-current="page">Tambah Pengeluaran</li>
            </ol>
        </nav>
    </div> --}}
                        ...
                        <form action="{{ route('admin.keuangan.pengeluaran.store') }}" method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                <select name="booking_id" id="booking_id" class="form-control"
                                    onchange="getBookingDetail(this.value)">
                                    <option value="">Pilih Booking Id</option>
                                    @foreach ($bookings as $booking)
                                        <option value="{{ $booking->id }}">{{ $booking->nama_pic }} -
                                            {{ $booking->organisasi }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="card p-3 bg-secondary-subtle">
                                ...
                                <h4 class="font-weight-bold">Detail Booking</h4>
                                ...
                                <div class="col">
                                    ...
                                    <div id="preview-container" class="mt-3">
                                        <img id="image-preview" src="#" alt="Preview Gambar"
                                            class="img-thumbnail" style="max-width: 30%; display: none;">
