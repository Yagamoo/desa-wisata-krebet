...
@section('menu')
    <p class="btn btn-primary text-light d-flex justify-content-between align-items-center me-3 "><a
            href="{{ route('admin.keuangan.index') }}" class=" text-light fw-bold m-1 ms-3"><i
    ...
    <p class="d-flex justify-content-between align-items-center me-3 "><a href="{{ route('admin.keuangan.pemasukan') }}"
            class="text-secondary m-1 ms-3 fw-bold"><i class=" me-2 bi bi-cash  ps-1 pe-1 rounded"></i> Pemasukan
        </a></p>
    ...
    <div class="card p-3 m-3">
        ...
        <div class="row g-3">
            <div class="col-md-6 col-lg-6">
                <a href="{{ route('admin.keuangan.pemasukan') }}" class="card bg-success text-white text-center p-3"
                    style="text-decoration: none">
                    <h5 class="fw-bold">Pemasukan</h5>
                    <p class="m-0 mt-2">Rp. {{ number_format($pemasukan, 0, ',', '.') }}</p>
                </a>
            </div>

            <div class="col-md-6 col-lg-6">
                <a href="{{ route('admin.keuangan.pengeluaran') }}" class="card bg-warning text-dark text-center p-3"
                    style="text-decoration: none">
                    <h5 class="fw-bold">Pengeluaran</h5>
                    <p class="m-0 mt-2">Rp. {{ number_format($pengeluaran, 0, ',', '.') }}</p>
                </a>
            </div>
        </div>
    </div>
    <div class="card p-3 m-3">
        <div class="card-title m-0 px-3 p-1">
            <h6 class="fw-bold m-0">Perbandingan Pemasukan & Pengeluaran</h6>
        ...
        <div class="col-12 bg-white rounde p-3">
            ...
            <div class="d-flex justify-content-center mb-3">
                <div class="btn-group" role="group" aria-label="Filter Keterangan">
                    <input type="radio" class="btn-check" name="btnradio" id="btnradio1" autocomplete="off" value="Semua"
                        checked>
